...
import IssuerGateway from '../../src/Card/interfaces/IssuerGateway'
...
const issuerUsers = [
  new IssuerUser('0', 'Test user 0', 'user@tgeste.com', '023434534545', Gender.N),
  new IssuerUser('1', 'Test user 1', 'user@tgeste.com', '00000000000', Gender.N)
]
...
export default class MockIssuer implements IssuerGateway {
  ...
  getUserByDocument(document: string) {
    return issuerUsers.find((user) => user.getDocument === document)
  }
  ...
  requestCard(user: IssuerUser, cardType: CardType, address?: Address | undefined): Card {
    return new Card('card-01', cardType)
  }
  ...
  getTransactions(accountId: string, fromDate?: Date | undefined, toDate?: Date | undefined) {
